...
public protocol PaginatedResult<T>: AnyObject, Sendable, Equatable {
    ...
    var next: (any PaginatedResult<T>)? { get async throws(AnyConvertibleToARTErrorInfo) }
    var first: any PaginatedResult<T> { get async throws(AnyConvertibleToARTErrorInfo) }
    var current: any PaginatedResult<T> { get async throws(AnyConvertibleToARTErrorInfo) }
}
...
internal final class PaginatedResultWrapper<T: JSONDecodable & Sendable & Equatable>: PaginatedResult {
    ...
    internal var next: (any PaginatedResult<T>)? {
        get async throws(AnyConvertibleToARTErrorInfo) {
