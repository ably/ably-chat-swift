...
public protocol PaginatedResult<T>: AnyObject, Sendable, Equatable {
    ...
    var next: (any PaginatedResult<T>)? { get async throws(ConvertibleToARTErrorInfo) }
    var first: any PaginatedResult<T> { get async throws(ConvertibleToARTErrorInfo) }
    var current: any PaginatedResult<T> { get async throws(ConvertibleToARTErrorInfo) }
}
...
internal final class PaginatedResultWrapper<T: JSONDecodable & Sendable & Equatable>: PaginatedResult {
    ...
    internal var next: (any PaginatedResult<T>)? {
        get async throws(ConvertibleToARTErrorInfo) {
