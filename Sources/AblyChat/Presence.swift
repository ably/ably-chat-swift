...
public protocol Presence: AnyObject, Sendable {
     ...
     */
    @discardableResult
    func subscribe(event: PresenceEventType, _ callback: @escaping ((PresenceEvent) -> Void)) -> SubscriptionHandle
     ...
     */
    @discardableResult
    func subscribe(events: [PresenceEventType], _ callback: @escaping ((PresenceEvent) -> Void)) -> SubscriptionHandle
