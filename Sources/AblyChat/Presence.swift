...
public protocol Presence: AnyObject, Sendable, EmitsDiscontinuities {
     ...
     */
    func get() async throws(AnyConvertibleToARTErrorInfo) -> [PresenceMember]
     ...
     */
    func get(params: PresenceQuery) async throws(AnyConvertibleToARTErrorInfo) -> [PresenceMember]
     ...
     * - Throws: An `ARTErrorInfo`.
     */
    func isUserPresent(clientID: String) async throws(AnyConvertibleToARTErrorInfo) -> Bool
     ...
     * - Throws: An `ARTErrorInfo`.
     */
    func enter(data: PresenceData) async throws(AnyConvertibleToARTErrorInfo)
     ...
     * - Throws: An `ARTErrorInfo`.
     */
    func update(data: PresenceData) async throws(AnyConvertibleToARTErrorInfo)
     ...
     * - Throws: An `ARTErrorInfo`.
     */
    func leave(data: PresenceData) async throws(AnyConvertibleToARTErrorInfo)
     ...
     * - Throws: An `ARTErrorInfo`.
     */
    func enter() async throws(AnyConvertibleToARTErrorInfo)
     ...
     * - Throws: An `ARTErrorInfo`.
     */
    func update() async throws(AnyConvertibleToARTErrorInfo)
     ...
     * - Throws: An `ARTErrorInfo`.
     */
    func leave() async throws(AnyConvertibleToARTErrorInfo)
