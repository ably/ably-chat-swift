...
internal final class DefaultRoomReactions: RoomReactions, EmitsDiscontinuities {
    ...
    // TODO: explain these "implementation" classes; they're to stop you getting hold of the channel by accident. We will be able to remove them once we get rid of these `channel` properties
    @MainActor
