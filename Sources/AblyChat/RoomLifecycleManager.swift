...
internal class DefaultRoomLifecycleManager: RoomLifecycleManager {
    ...
    @discardableResult
    internal func onRoomStatusChange(_ callback: @escaping @MainActor (RoomStatusChange) -> Void) -> StatusSubscription {
    ...
    @discardableResult
    internal func onDiscontinuity(_ callback: @escaping @MainActor (DiscontinuityEvent) -> Void) -> StatusSubscription {
    ...
    private struct OperationResultContinuations {
        ...
        internal func testsOnly_subscribeToOperationWaitEvents(_ callback: @escaping @MainActor (OperationWaitEvent) -> Void) -> Subscription {
    ...
    internal func waitToBeAbleToPerformPresenceOperations(requestedByFeature requester: RoomFeature) async throws(InternalError) {
        ...
        internal func testsOnly_subscribeToStatusChangeWaitEvents(_ callback: @escaping @MainActor (StatusChangeWaitEvent) -> Void) -> Subscription {
