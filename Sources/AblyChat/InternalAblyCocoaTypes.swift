...
// TODO: explain that this is where we put the stuff that we want the library to use internally
// TODO: explain that for now it's just the subset of functionality that we actually use in the SDK
// TODO: rename these to something like "SwiftRealtimeClient"
...
internal protocol InternalRealtimeChannelProtocol: AnyObject, Sendable {
    ...
    // TODO: explain — it's needed to be able to return from the `channel` methods
