...
public protocol Messages: AnyObject, Sendable, EmitsDiscontinuities {
     ...
     */
    func subscribe(bufferingPolicy: BufferingPolicy) async throws(ConvertibleToARTErrorInfo) -> MessageSubscription

    /// Same as calling ``subscribe(bufferingPolicy:)`` with ``BufferingPolicy/unbounded``.
    ///
    /// The `Messages` protocol provides a default implementation of this method.
    func subscribe() async throws(ConvertibleToARTErrorInfo) -> MessageSubscription
     ...
     */
    func get(options: QueryOptions) async throws(ConvertibleToARTErrorInfo) -> any PaginatedResult<Message>
     ...
     */
    func send(params: SendMessageParams) async throws(ConvertibleToARTErrorInfo) -> Message
     ...
     * - Note: It is possible to receive your own message via the messages subscription before this method returns.
     */
    func update(newMessage: Message, description: String?, metadata: OperationMetadata?) async throws(ConvertibleToARTErrorInfo) -> Message
     ...
     * - Note: It is possible to receive your own message via the messages subscription before this method returns.
     */
    func delete(message: Message, params: DeleteMessageParams) async throws(ConvertibleToARTErrorInfo) -> Message
