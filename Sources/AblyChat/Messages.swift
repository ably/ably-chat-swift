...
public protocol Messages: AnyObject, Sendable, EmitsDiscontinuities {
     ...
     */
    func subscribe(bufferingPolicy: BufferingPolicy) async throws(AnyConvertibleToARTErrorInfo) -> MessageSubscription

    /// Same as calling ``subscribe(bufferingPolicy:)`` with ``BufferingPolicy/unbounded``.
    ///
    /// The `Messages` protocol provides a default implementation of this method.
    func subscribe() async throws(AnyConvertibleToARTErrorInfo) -> MessageSubscription
     ...
     */
    func get(options: QueryOptions) async throws(AnyConvertibleToARTErrorInfo) -> any PaginatedResult<Message>
     ...
     */
    func send(params: SendMessageParams) async throws(AnyConvertibleToARTErrorInfo) -> Message
     ...
     * - Note: It is possible to receive your own message via the messages subscription before this method returns.
     */
    func update(newMessage: Message, description: String?, metadata: OperationMetadata?) async throws(AnyConvertibleToARTErrorInfo) -> Message
     ...
     * - Note: It is possible to receive your own message via the messages subscription before this method returns.
     */
    func delete(message: Message, params: DeleteMessageParams) async throws(AnyConvertibleToARTErrorInfo) -> Message
