...
internal final class DefaultMessages: Messages, EmitsDiscontinuities {
    ...
    internal func subscribe(bufferingPolicy: BufferingPolicy) async throws(AnyConvertibleToARTErrorInfo) -> MessageSubscription {
    ...
    internal func get(options: QueryOptions) async throws(AnyConvertibleToARTErrorInfo) -> any PaginatedResult<Message> {
        try await chatAPI.getMessages(roomId: roomID, params: options)
    }

    internal func send(params: SendMessageParams) async throws(AnyConvertibleToARTErrorInfo) -> Message {
        try await chatAPI.sendMessage(roomId: roomID, params: params)
    }

    internal func update(newMessage: Message, description: String?, metadata: OperationMetadata?) async throws(AnyConvertibleToARTErrorInfo) -> Message {
        try await chatAPI.updateMessage(with: newMessage, description: description, metadata: metadata)
    }

    internal func delete(message: Message, params: DeleteMessageParams) async throws(AnyConvertibleToARTErrorInfo) -> Message {
    ...
    private func resolveSubscriptionStart() async throws(AnyConvertibleToARTErrorInfo) -> String {
    ...
    private func serialOnChannelAttach() async throws(AnyConvertibleToARTErrorInfo) -> String {
