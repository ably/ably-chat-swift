 ...
 */
@MainActor
public protocol StatusSubscriptionProtocol {
    /**
 ...
 */
public struct MessageSubscriptionResponse: SubscriptionProtocol, Sendable {
    private let _unsubscribe: () -> Void
     ...
     */
    public func historyBeforeSubscribe(_ params: QueryOptions = .init()) async throws(ARTErrorInfo) -> any PaginatedResult<Message> {
