...
public protocol Rooms: AnyObject, Sendable {
     ...
     */
    func get(roomID: String, options: RoomOptions) async throws(AnyConvertibleToARTErrorInfo) -> any Room
...
internal actor DefaultRooms<RoomFactory: AblyChat.RoomFactory>: Rooms {
    ...
    private enum RoomMapEntry {
        ...
        func waitForRoom() async throws(AnyConvertibleToARTErrorInfo) -> RoomFactory.Room {
            switch self {
    ...
    internal func get(roomID: String, options: RoomOptions) async throws(AnyConvertibleToARTErrorInfo) -> any Room {
    ...
    private func createRoom(roomID: String, options: RoomOptions) async throws(AnyConvertibleToARTErrorInfo) -> RoomFactory.Room {
