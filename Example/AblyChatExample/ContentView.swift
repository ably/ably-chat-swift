...
struct ContentView: View {
    ...
    func addMessageReaction(_ reaction: String, messageSerial: String) {
        Task {
            try await room().messages.reactions.add(for: messageSerial, params: .init(reaction: reaction, type: .distinct))
        }
    }

    func deleteMessageReaction(_ reaction: String, messageSerial: String) {
        Task {
            try await room().messages.reactions.delete(for: messageSerial, params: .init(reaction: reaction, type: .distinct))
        }
    }
