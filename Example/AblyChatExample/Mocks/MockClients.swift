...
class MockPresence: Presence {
    ...
    private func createSubscription(callback: @escaping (PresenceEvent) -> Void) -> SubscriptionHandle {
        mockSubscriptions.create(
            randomElement: {
                PresenceEvent(
    ...
    func subscribe(event _: PresenceEventType, _ callback: @escaping ((PresenceEvent) -> Void)) -> SubscriptionHandle {
        createSubscription(callback: callback)
    }

    func subscribe(events _: [PresenceEventType], _ callback: @escaping ((PresenceEvent) -> Void)) -> SubscriptionHandle {
        createSubscription(callback: callback)
    }
}
