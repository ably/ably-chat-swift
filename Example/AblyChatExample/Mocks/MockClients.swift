...
class MockRoom: Room {
    ...
    @discardableResult
    func onDiscontinuity(_: @escaping @MainActor (DiscontinuityEvent) -> Void) -> StatusSubscription {
        fatalError("Not yet implemented")
    }
}
...
class MockMessages: Messages {
    ...
    func subscribe(_ callback: @escaping @MainActor (Message) -> Void) async throws(ARTErrorInfo) -> MessageSubscriptionResponse {
...
class MockRoomReactions: RoomReactions {
    ...
    @discardableResult
    func subscribe(_ callback: @escaping @MainActor (Reaction) -> Void) -> Subscription {
        mockSubscriptions.create(
            randomElement: {
                Reaction(
...
class MockPresence: Presence {
    ...
    private func createSubscription(callback: @escaping @MainActor (PresenceEvent) -> Void) -> Subscription {
        mockSubscriptions.create(
            randomElement: {
                PresenceEvent(
    ...
    func subscribe(event _: PresenceEventType, _ callback: @escaping @MainActor (PresenceEvent) -> Void) -> Subscription {
        createSubscription(callback: callback)
    }

    func subscribe(events _: [PresenceEventType], _ callback: @escaping @MainActor (PresenceEvent) -> Void) -> Subscription {
        createSubscription(callback: callback)
    }
}
