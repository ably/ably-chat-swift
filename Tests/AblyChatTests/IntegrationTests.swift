...
struct IntegrationTests {
    ...
    func basicIntegrationTest() async throws {
        ...
        try await txRoom.presence.enter(data: ["randomData": .string("randomValue")])
        ...
        #expect(rxPresenceEnterTxEvent.data?["randomData"]?.value as? String == "randomValue")

        // (3) Send `.update` presence event with custom data on the other client and check that we receive it on the subscription
        try await txRoom.presence.update(data: ["randomData": .string("randomValue")])
        ...
        #expect(rxPresenceUpdateTxEvent.data?["randomData"]?.value as? String == "randomValue")

        // (4) Send `.leave` presence event with custom data on the other client and check that we receive it on the subscription
        try await txRoom.presence.leave(data: ["randomData": .string("randomValue")])
        ...
        #expect(rxPresenceLeaveTxEvent.data?["randomData"]?.value as? String == "randomValue")
        ...
        #expect(rxPresenceEnterRxEvent.data?["randomData"]?.value as? String == "randomValue")
        ...
        #expect(rxPresenceUpdateRxEvent.data?["randomData"]?.value as? String == "randomValue")
        ...
        #expect(rxPresenceLeaveRxEvent.data?["randomData"]?.value as? String == "randomValue")
