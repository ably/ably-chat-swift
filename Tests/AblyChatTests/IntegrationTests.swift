...
struct IntegrationTests {
    ...
    func basicIntegrationTest() async throws {
        ...
        try await txRoom.presence.enter(data: .object(["randomData": .string("randomValue")]))
        ...
        #expect(rxPresenceEnterTxEvent.data == .object(["randomData": .string("randomValue")]))

        // (3) Send `.update` presence event with custom data on the other client and check that we receive it on the subscription
        try await txRoom.presence.update(data: .object(["randomData": .string("randomValue")]))
        ...
        #expect(rxPresenceUpdateTxEvent.data == .object(["randomData": .string("randomValue")]))

        // (4) Send `.leave` presence event with custom data on the other client and check that we receive it on the subscription
        try await txRoom.presence.leave(data: .object(["randomData": .string("randomValue")]))
        ...
        #expect(rxPresenceLeaveTxEvent.data == .object(["randomData": .string("randomValue")]))
        ...
        #expect(rxPresenceEnterRxEvent.data == .object(["randomData": .string("randomValue")]))
        ...
        #expect(rxPresenceUpdateRxEvent.data == .object(["randomData": .string("randomValue")]))
        ...
        #expect(rxPresenceLeaveRxEvent.data == .object(["randomData": .string("randomValue")]))
