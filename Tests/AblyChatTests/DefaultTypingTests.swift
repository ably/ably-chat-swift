...
struct DefaultTypingTests {
    ...
    // @spec CHA-T4: Users may indicate that they have started typing using the keystroke method
    @Test
...
//            }
    ...
    // @spec CHA-T4a5: The client must wait for the publish to succeed or fail before returning the result to the caller
    @Test
    ...
    // @spec CHA-T5: Users may explicitly indicate that they have stopped typing using stop method
    @Test
    ...
    // @spec CHA-T5a: If typing is not in progress, stop operation is a no-op
    @Test
