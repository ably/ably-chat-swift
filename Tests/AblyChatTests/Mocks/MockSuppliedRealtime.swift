...
final class MockSuppliedRealtime: NSObject, SuppliedRealtimeClientProtocol, @unchecked Sendable {
    ...
    final class Annotations: RealtimeAnnotationsProtocol {
        func publish(_: ARTAnnotation, messageSerial _: String, callback _: ARTAnnotationErrorCallback? = nil) {
            fatalError("Not implemented")
        }

        func unpublish(_: ARTAnnotation, messageSerial _: String, callback _: ARTAnnotationErrorCallback? = nil) {
            fatalError("Not implemented")
        }
